      ...
      <main id="content" role="main">
        ...
        <div className="mb-5">
          <div
            ...
            style={{
              backgroundImage: "url(img/1920X422/img1.jpg)",
            }}
          >
              ...
              >
                <div className="js-slide bg-img-hero-center">
                  <div className="row min-height-420 py-7 py-md-0">
                    ...
                    <div
                      className="col-xl-5 col-6  d-flex align-items-center"
                      data-scs-animation-in="zoomIn"
                      data-scs-animation-delay={500}
                    >
                      <img
                        className="img-fluid"
                        src="img/416X420/img1.png"
                ...
                >
                  <div className="row min-height-420 py-7 py-md-0">
                    <div className="offset-xl-3 col-xl-4 col-6 mt-md-8">
                      ...
                      <a
                        href="../shop/single-product-fullwidth.html"
                        className="btn btn-primary transition-3d-hover rounded-lg font-weight-normal py-2 px-md-7 px-3 font-size-15"
                        data-scs-animation-in="fadeInUp"
                        data-scs-animation-delay={400}
                      >
                        Start Buying
                ...
                <div className="p-3 border border-width-2 border-primary borders-radius-20 bg-white min-width-370">
                  ...
                  <div className="mb-2">
                    ...
                    >
                      ...
                      <div className="mx-1 pt-1 text-gray-2 font-size-24">
                        :
                      </div>
                      <div className="text-lh-1">
                        <div className="text-gray-2 font-size-30 bg-gray-4 py-2 px-2 rounded-sm mb-2">
                            ...
                            <div className="product-item__body d-flex flex-column">
                              ...
                              <div className="flex-center-between">
                                ...
                                <div className="d-none d-xl-block prodcut-add-cart">
                                  ...
                                  >
                                    <i className="ec ec-add-to-cart mr-2" /> Add
                                    to Cart
                                  </a>
                                </div>
                              </div>
        ...
        <div className="container">
          ...
          <div className="space-top-2">
            ...
            <div
              className="js-slick-carousel u-slick u-slick--gutters-2 overflow-hidden u-slick-overflow-visble pt-3 pb-6"
